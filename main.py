...
class Boudrerrie(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content.lower().startswith('!sounds'):
            embed = discord.Embed(
                title="Drerrie Command Registry", description="sound commands en de files", color=discord.Colour.random())
            for commandkey, commandvalue in self.CommandRegistry.items():
        ...
        if message.content.lower().startswith('!'):
            ...
            if filename != None:
                ...
                await message.author.send("Nou sound is bound to this command \n" +
                                          ...
                                          "If you want a list of commands you can say !commands in general")
